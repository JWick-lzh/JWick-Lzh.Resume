...
window.RESUME = {
  zh: {
    ...
    summary: [
      "10 年+ toB/SaaS 产品经验，做过供应链中台、智能客服、企业级 AI Agent 平台等产品，推动企业供应链 SaaS 企业向「AI Agent 赋能经营」持续转型，从 0 搭起覆盖经营分析、智能采购、智能录单与多租户 Agent 平台底座的 AI 产品矩阵；并带 20 人团队交付企业级 AI Agent 平台，上线第一个月签下付费客户。",
      "完整跑通过商业闭环：从售前方案到产品交付再到客户续签，带队完成过全年数千万业绩目标，累计做了 10+ 次企业级客户方案演示和签约。",
      "有从 0 拉团队经验，带过 20+ 人团队（产品 + 前后端 + 算法 + 设计），用 2 周 Sprint 敏捷节奏推进，4 个月内从概念验证做到商业化版本上线。",
      "对 AI 技术有实际落地经验，熟悉大模型、Agent、MCP 等技术；负责过自然语言任务流交互、MCP 插件机制、多 Agent 协作体系的产品设计；推动框架开源吸引 4000+ 开发者。"
    ],
    experience: [
      {
        company: "观麦科技",
        ...
        duties: [
          "作为公司 AI 产品一号位，统筹约 80 人产品研发中心，负责观麦 AI 产品线整体规划与落地，推动公司从生鲜供应链 SaaS（Ceres）向「AI Agent 赋能经营」升级，从 0 搭起覆盖「经营分析 + 智能采购 + 智能录单 + Agent 平台底座」的 AI 产品矩阵；",
          ...
          "推动多模态智能录单能力落地，打通文本 / 图片 / PDF / Excel 多渠道订单到结构化订单的自动转换，沉淀商品名称归一化规则库；",
          "推动 AI 工程化与降本：多模型分层网关（按成本-性能路由）、MCP 协议对接核心 ERP / WMS、记忆分层与提示词缓存控住 token 成本、TDD + 规范驱动的 AI 协作开发模式；",
          "把 AI 能力沉淀成可复用资产：生鲜行业知识词表、多模态信息抽取、知识库审核闭环、分层记忆系统等，支撑上层多个业务 Agent 快速孵化。"
        ],
        results: [
          "入职几个月内带队从 0 跑通经营分析、智能采购、智能录单三条 AI 产品线，并搭出多租户 Agent 平台底座，完成端到端可演示的 MVP；",
      ...
      },
      {
        ...
        duties: [
          "主导集团连锁经营 SaaS 平台的产品搭建和迭代，推动平台经历 v1.0（信息化）→ v2.0（数据化）→ v3.0（智能化）三代升级，覆盖门店运营、供应链协同、智能陈列、数据决策等能力，服务覆盖全国 300+ 城市连锁门店；",
          "统筹 10+ 款核心产品规划与交付：Teamshare OS 一体化办公平台、司南 BI 数据分析平台、低代码平台、VCM 可视化陈列系统、开天智慧零售大脑、POS 门店收银、WMS 仓储管理、供应链协同、建店管理等；",
          "推动「企业智能大脑」中台建设：以低代码平台为底座，结合规则引擎与连接器（IFTTT）串联 SOP/非 SOP 业务，实现「系统执行规则、人制定规则」，用数据驱动业务增长；",
          "负责企业级 AI Agent 平台产品方向与规划，确定「开源全栈 + 企业 OA 整合」定位；将产品从单一 Agent 工具升级为涵盖「AI Agent + 工作流编排 + 即时通讯 + 协同办公」的生产力平台，打造国内第一个企业级开源 AI 生产力平台；",
          "组建并带领 20+ 人跨职能团队，引入敏捷开发流程，4 个月完成从概念验证到商业化版本上线；设计自然语言驱动任务流交互，推动 MCP 插件机制上线，打通企业微信/钉钉/飞书集成；推动 Agentlang 框架开源吸引 4000+ 开发者；",
          "设计 SaaS 云服务 / Docker 社区版 / 企业私有化部署三条商业化路径；负责对外方案输出，配合售前完成企业客户需求沟通与方案演示，沉淀可复制的「1+4」行业标准解决方案，推动商业闭环落地；",
          "持续跟踪 AI Agent、多模态大模型、MCP 协议等技术趋势，发现市场机会并推动产品迭代。"
        ],
        results: [
          "上线当月签约 2 家付费企业客户，获得 5000+ 海内外注册用户；",
          "推动多 Agent 协作体系与多条产品线打通，客户实测效率明显提升（如投资分析报告从 2 天缩短到半天出初稿）；",
      ...
      },
      {
        ...
        duties: [
          ...
          "搭建供应链中台：建立供应商中心、招采中心、商品中心、合同中心四大中心，抽象出招投标引擎、营销自动化引擎等中台能力；",
      ...
      },
      {
        ...
        duties: [
          ...
          "负责低代码商业产品「氚云」的规划，完成市场分析、MVP 定义、需求落地，带团队持续迭代；",
    ...
    projects: [
      {
        ...
        period: "2026.04 — 至今",
        category: "AI",
        background: "观麦的 AI 助手越做越多（经营、采购、录单…），但每个都各搭一套底层、重复造轮子。需要一个统一的多租户 Agent 平台，把模型接入、知识库、记忆、对话信道这些公共能力沉下去，让上层 Agent 专注业务。",
        duties: [
          "作为产品负责人主导平台从 0 规划，架构方案迭代 15 版，定下整体架构思路和工程骨架；",
          "设计多模型网关，按「便宜快 / 均衡 / 高智能」三档路由不同模型，换底层模型只改配置、上层 Agent 零改动；",
          "定知识库方案：用 RAGFlow 做检索底座，设计 27 类生鲜行业知识词表 + 多字段元数据的双轨检索，系统知识库与租户知识库自动融合；",
          "设计分层记忆系统（对话工作记忆 → 中期压缩 → 长期画像），用降频与提示词缓存控住 token 成本；",
      ...
      },
      {
        ...
        duties: [
          ...
          "设计知识库全生命周期闭环：附件「切片 → 向量化 → LLM 提炼成结构化知识条目 → 人工审核 → 上线」，低置信度或业务冲突自动拦截走审核工单；",
      ...
      },
      {
        ...
        duties: [
          ...
          "推动选用智谱 GLM 多模态（文本 + 图片报价识别），并对齐采宝与龙虾的技术栈（FastAPI + React）。"
        ],
        results: [
      ...
      },
      {
        ...
        results: [
          "平台覆盖全国 300+ 城市连锁门店，服务 10+ 连锁品牌客户，平台年营收 200 万+；",
          "落地 10+ 款核心产品，覆盖办公协同、门店管理、供应链、智能陈列、数据决策全链路数字化；",
          "单店日常运营效率提升 40%；开天智慧零售大脑驱动的智能补货准确率达 85%+，缺货损失降低约 30%；",
      ...
      },
      {
        ...
        duties: [
          ...
          "协调银行、保理公司等外部合作方，推动风控模型与系统对接；带领 6 人产品团队完成交付。"
        ],
        results: [
